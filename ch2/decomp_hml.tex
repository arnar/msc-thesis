...
\begin{proof}
    ...
    \proofcase{Case $\phi = \psi_1 \land \psi_2$}
    ...
    \proofcase{Case $\phi = \dmnd\alpha\psi$}
    ...
    \proofcase{Case $\phi = \dmndback\alpha\psi$}
    ...
    \proofcase{Case $\phi = \pdmnd{i}, i\in \mathbb{N}$}
    ...
    \proofcase{Case $\phi = \pdmndback{i}, i\in \mathbb{N}$}
